...
countGrade([-1,-1,-1,-1,-1,-1]) should return {S:0, A:0, B:0, C:0, D:0, 
*/

function countGrade(scores){
    let s=scores.filter((e,i)=>e===100).length
    let a=scores.filter((e,i)=>e<100&&e>=90).length
    let b=scores.filter((e,i)=>e<90&&e>=80).length
    let c=scores.filter((e,i)=>e<80&&e>=60).length
    let d=scores.filter((e,i)=>e<60&&e>=0).length
    let x=scores.filter((e,i)=>e===-1).length
