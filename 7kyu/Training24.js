...
it's a 1D number array. Your task is to merge each of the 3 elements into 1 elements (sum value) and return the result.
...
function threeInOne(arr){
    ...
    let arrNumber=arr.length/3
    for (let i=0;i<arrNumber;i++){
        ArrayList.push(newArr.splice(0,3).reduce((acc,i)=>acc+=i))
    }
    return ArrayList
